  ...
  async function getGames() {
    ...
    try {
      ...
      const response = await fetch(
        "https://api.rawg.io/api/games?key=795574157c904a59976d02fb5d132e4e&page_size=39"
      );
    ...
    if (searchQuery.length === 0) {
      ...
      try {
        response = await fetch(
          `https://api.rawg.io/api/games?key=795574157c904a59976d02fb5d132e4e&search=${searchQuery}&page_size=39`
        );
